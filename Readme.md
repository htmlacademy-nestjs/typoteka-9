...
Учебный демо-проект от HTML Academy курса «Node.js и Nest.js. Микросервисная архитектура», 9 поток.

## Как пользоваться репозиторием

Первый вариант, это изучать коммиты [в веб-интерфейсе GitHub в master-ветке потока](https://github.com/htmlacademy-nestjs/typoteka-9).
